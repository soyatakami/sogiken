...
#include "coyomi_structs.h"     // ← 構造体: InputData / SentData / ReceiveData
#include "coyomi_gui_consts.h"  // ← PACKET_WORDS / FLAG_* / MIN_* など
#include "coyomi_messages_ja.h" // ← 日本語メッセージ/GUIテキスト
...
// 分離したヘッダ
//==============================
#include "coyomi_structs.h"     // InputData / SentData / ReceiveData
#include "coyomi_gui_consts.h"  // GUIレイアウト定数・PACKET_WORDS・FLAG_*・MIN/MAX など
...
// コントロール生成
//==============================
// ── コントロール生成（配置・フォント指定は coyomi_gui_consts.h の #define を使用） ──
