...
// 構成: Main / CreateWindow.c / CollectData.c / InvalidValueHandling.c / ConnectToCoyomi.c / UIntRecive.c
// ビルド例:
// gcc Coyomi_Client_Test_GUI_v22.c CreateWindow.c CollectData.c InvalidValueHandling.c ConnectToCoyomi.c UIntRecive.c \
